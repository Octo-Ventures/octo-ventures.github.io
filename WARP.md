...
## Project Overview
Octo Ventures is a static HTML/CSS portfolio website hosted on GitHub Pages. The site includes multiple pages (index, about, services, testimonials, contact) with responsive design and integrated chat functionality via Genesys.
...
- **CSS** (`css/style.css`) - centralized styling for all pages; uses responsive design patterns
